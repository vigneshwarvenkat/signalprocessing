...
# Title: Chat App
# Generated: Tue Nov  9 07:37:40 2021
##################################################
...
class chat_app(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(1, firdes.low_pass(
        	100, fs_in, 200e3, 50e3, firdes.WIN_HAMMING, 6.76))
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\Users\\Vignesh\\OneDrive\\Desktop\\EE2033\\PRoject\\Miniproject\\LTSPICE\\testspice.dat', True)
    ...
    def set_fs_in(self, fs_in):
        self.fs_in = fs_in
        self.low_pass_filter_0.set_taps(firdes.low_pass(100, self.fs_in, 200e3, 50e3, firdes.WIN_HAMMING, 6.76))
